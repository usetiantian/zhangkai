# -*- coding: utf-8 -*-
"""Fix evokg — use chr(92) for backslash, not f-string."""
...
new = '''        # v20: Quality gate — heuristic rules (no hardcoded filenames)
        content_str = str(content)
        ...
        has_path = '/' in content_str or chr(92) in content_str
...
print('[OK] evokg — heuristic rules, using chr(92) for backslash')
